...
def search_epic_patients(
    ...
    output_filename: str | None = "epic_patients_results.csv",
    ...
    if output_filename and os.path.exists(output_filename) and not overwrite:
        logger.debug(f"Loading existing epic patient data from {output_filename}")
    ...
    if output_filename:
        ...
        logger.debug(f"Saving epic patient data to {output_filename}")
