...
def search_vte(
    ...
    output_filename: Optional[str] = "vte_search_results.csv",
    ...
    Args:
        ...
        fields_override (Optional[List[str]]): A list of fields to override the
            default `VTE_FIELDS`. Defaults to None.
        ...
        output_filename (Optional[str]): The filename or path to a CSV file to
            load from or save to. Defaults to "vte_search_results.csv".
