...
def get_current_pat_epic_imaging_reports_annotations(
    ...
    epic_imaging_reports_annotations: Optional[pd.DataFrame],
    ...
    if epic_imaging_reports_annotations is None:
        raise ValueError(
            "epic_imaging_reports_annotations cannot be None. Please provide a valid DataFrame."
        )
    ...
    time_column = getattr(
        config_obj, "epic_imaging_reports_time_field", "document_CreatedWhen"
    )
