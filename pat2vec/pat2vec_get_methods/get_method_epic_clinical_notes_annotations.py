...
def get_current_pat_epic_clinical_notes_annotations(
    ...
    _logger.debug(
        f"Processing epic_clinical_notes_annotations for patient {current_pat_client_id_code}",
    )
    _logger.debug(f"Input annotations shape: {epic_clinical_notes_annotations.shape}")
    _logger.debug(f"Time column used: {time_column}")

    if config_obj.verbosity >= 7:
        _logger.debug("Filtering epic clinical notes annotations...")
        _logger.debug(
