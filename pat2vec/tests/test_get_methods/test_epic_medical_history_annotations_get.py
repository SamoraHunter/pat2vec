...
"""
        ...
        # Generate and ingest Epic medical history data
    ...
    def test_3_index_population_and_verification(self):
        ...
        # Verify epic_medical_history index has documents
        es_count = self.cs.elastic.count(index="epic_medical_history")["count"]
        expected_mc_count = len(self.patient_ids) * 3  # 5 patients * 3 rows each
        assert (
    ...
    def test_6_epic_medical_history_annotations_data_retrieval(self):
        ...
        # epic_medical_history uses get_all_features() for feature extraction
        from pat2vec.util.helper_functions import get_all_features
    ...
    def test_7_merge_epic_medical_history_annotations_functionality(self):
        ...
        # For annotation-based sources, merge means getting features from database
