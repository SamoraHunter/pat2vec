...
"""
        ...
        # Generate and ingest appointment data
        appointments_dfs = []
    ...
    def test_3_index_population_and_verification(self):
        ...
        # Verify appointments were ingested
        es_count = self.cs.elastic.count(index="pims_apps")["count"]
        expected_appointment_count = (
    ...
    def test_appointments_data_retrieval(self):
        """Test appointments data retrieval - verify appointment features can be retrieved."""
    ...
    def test_merge_appointments_data_functionality(self):
        """Test merge appointments data functionality - verify merge function creates CSV."""
        all_pat_list = self.pat2vec_obj.all_patient_list
    ...
    def teardown_class(cls: type) -> None:
        """Clean up after all tests - stop ES container only."""
        cls.es_container.stop()
