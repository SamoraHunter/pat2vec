...
def copy_files_and_dirs(
    ...
    if items_to_copy is None:
        items_to_copy = [
            ...
            "current_pat_textual_obs_annotations_batches",
            "current_pat_documents_annotations_batches_reports",
            "current_pat_epic_orders_annotations_batches",
            "current_pat_epic_clinical_notes_annotations_batches",
            "current_pat_epic_clinical_notes_appointments_annotations_batches",
            "current_pat_epic_medical_history_annotations_batches",
            "current_pat_epic_imaging_reports_annotations_batches",
            "current_pat_epic_encounters_batches",
            "current_pat_bloods_batches",
            "current_pat_drugs_batches",
            "current_pat_diagnostics_batches",
            "current_pat_news_batches",
            "current_pat_bmi_batches",
            "current_pat_demo_batches",
            "current_pat_textual_obs_document_batches",
            "current_pat_document_batches_reports",
            "current_pat_appointments_batches",
            "current_pat_obs_batches",
            "current_pat_misc_batches",
            "current_pat_epic_clinical_notes_batches",
            "current_pat_epic_medical_history_batches",
            "current_pat_epic_orders_batches",
            "current_pat_epic_lab_results_batches",
            "current_pat_epic_patients_batches",
            "current_pat_epic_imaging_reports_batches",
            "current_pat_epic_clinical_notes_appointments_batches",
        ]
