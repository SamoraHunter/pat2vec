...
class EthnicityAbstractor:
    def abstractEthnicity(dataFrame, outputNameString, ethnicityColumnString):
        ...
        racecodeEntries = pd.DataFrame(
            racecodeEntries, columns=[targetColumnString])

        racecodeEntries[targetColumnString] = racecodeEntries[targetColumnString].fillna(
            'other_ethnic_group')
        ...
        blackList = ['black', 'african', 'caribbean',
                     'black british', 'black african', 'black carribean']

        whiteList = ['white', 'caucasian', 'gypsy',
                     'traveller', 'other white', 'white other']

        asianList = ['asian', 'chinese', 'pakistani', 'bangladeshi', 'indian']

        otherList = ['arab', 'not specified']

        mixedList = ['mixed', 'multiple', 'biracial', 'multiracial', 'white and asian', 'white and black',
                     'white and hispanic', 'black and white', 'asian and white', 'hispanic and white']
